...
**Here, the `add(3)` just like to create a object (names *closure*), and it can be called, same as a function.** *(In some language, all function is just a special closure.)*
