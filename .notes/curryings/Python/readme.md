...
Or you can: 
- Use the *[toolz](https://toolz.readthedocs.io/ "Toolz is pure Python; Toolz relies only on the standard library; Toolz simultaneously supports Python versions 3.4+ and PyPy !!")* by [`pip install toolz`](https://pypi.org/project/toolz/ "A set of utility functions for iterators, functions, and dictionaries.") or [`pip install cytoolz`](https://pypi.org/project/cytoolz/ "Cython implementation of the toolz package, which provides high performance utility functions for iterables, functions, and dictionaries.") if you use the *cython*. They have things about currying. Repo: [`pytoolz/toolz`](https://github.com/pytoolz/toolz.git "A functional standard library for Python.") [`pytoolz/cytoolz`](https://github.com/pytoolz/cytoolz.git "Cython implementation of Toolz: High performance functional utilities")
- Use the *[pymonad](https://jasondelaat.github.io/pymonad_docs/ "Pymonad Documentation Project")* by [`pip install PyMonad`](https://pypi.org/project/PyMonad/ "Data structures and utilities for monadic style functional programming.") then use the `@pymonad.tools.curry(n)` decorator. Repo: [`jasondelaat/pymonad`](https://github.com/jasondelaat/pymonad.git "(BSD-3-Clause) (Languages: Python 100.0%) PyMonad implements data structures typically available in pure functional or functional first programming languages like Haskell and F#. Included are Monad and Monoid data types with several common monads included - such as Maybe and State - as well as some useful tools such as the @curry decorator for defining curried functions. PyMonad 2.0.x represents and almost complete re-write of the library with a simpler, more consistent interface as well as type annotations to help ensure correct usage.") [`jasondelaat/pymonad_docs`](https://github.com/jasondelaat/pymonad_docs.git "(Languages: HTML 100.0%) Official documentation for the PyMonad project.")
